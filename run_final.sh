...
papermill -p IRT_DIMS 0 -p DATASET matrix -p ITEM_FEATURES GNN_final.ipynb | jupyter-nbconvert --stdin --no-input --to html --output vis/GNN_batch_SAGE_matrix_scales.html > logs/GNN_batch_SAGE_matrix.log
papermill -p IRT_DIMS 0 -p DATASET topic -p ITEM_FEATURES GNN_final.ipynb | jupyter-nbconvert --stdin --no-input --to html --output vis/GNN_batch_SAGE_topic_scales.html > logs/GNN_batch_SAGE_topic.log
