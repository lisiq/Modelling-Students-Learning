...
papermill -p IRT_DIMS 0 -p DATASET topic GNN_final.ipynb | jupyter-nbconvert --stdin --no-input --to html --output vis/GNN_batch_SAGE_topic.html > logs/GNN_batch_IRT_SAGE_topic.log